...
@Service
public class EmailAlwaysNotExistsPolicy extends EmailShallNotExistPolicy {

    public EmailAlwaysNotExistsPolicy(MessageSource msgSource) {
        super(msgSource);
    }

    public ResultMap<String> check(String username) {
        return ResultMap.success("Ok, email is not known");
    }
}
